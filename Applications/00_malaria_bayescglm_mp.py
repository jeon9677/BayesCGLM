...
def job(weights, X_input, X_cv, X_train_covariate, X_cv_covariate, Zmat_data, Zmat_cv, idx):
    ...
    return _results.params[-3:], pred, acc, fishers, inverse_fisher  # normal
...
def main():
    ...
    # mc_model = load_model(f'model_malaria/mc_model_update_new_final_0214_2.h5')  # final
    ...
    logging.debug('glm')
    exp_name = f'{n_model}'
    exp_dir = f'model_malaria/{exp_name}'
